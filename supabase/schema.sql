-- ==============================================================================
-- SponsorFlow: Complete Database Schema Reference (Single File)
-- For execution in Supabase SQL Editor or direct psql connection
-- ==============================================================================
...
-- Triggers for normalization and email hash
